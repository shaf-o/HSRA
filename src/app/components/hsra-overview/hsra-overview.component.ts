...
@Component({
  selector: 'app-hsra-overview',
  templateUrl: './hsra-overview.component.html',
  styleUrls: ['./hsra-overview.component.css']
})
export class HsraOverviewComponent implements OnInit {
